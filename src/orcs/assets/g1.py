"""Flat-hand Unitree G1 — the SONIC WBC base robot.

Stock mjlab G1 with capsule hand colliders swapped for thin box plates via
MjSpec surgery (stable object contact); joint dynamics untouched. The flat_hand
visual mesh comes from the ``assets`` dep (``g1/meshes``).
"""
